...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint(
            "mental_activity >= 0 AND mental_activity <= 10",
            name="ck_check_ins_mental_activity_range",
        ),
        sa.CheckConstraint(
            "sleepiness >= 0 AND sleepiness <= 10", name="ck_check_ins_sleepiness_range"
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "status IN ('created', 'started', 'completed', 'abandoned')", name="ck_sessions_status"
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "after_score >= 0 AND after_score <= 10", name="ck_session_feedback_after_score_range"
        ),
        sa.CheckConstraint(
            "before_score >= 0 AND before_score <= 10",
            name="ck_session_feedback_before_score_range",
        ),
        sa.CheckConstraint(
